...
function loginPwd() {
    ...
    var obj = {
        ...
        data:[{
            ...
            {
                "field_name":"phoneno","match":"=","field_value":phonestr
            }]
    };
...
function registerPwd(){
    ...
    var obj = {
        ...
        data: [{
            ...
            "match": "=",
            "field_value": "efdce07cd05b11e98dec00163e3005fb"
        }, {
            "field_name": "phoneno",
            "match": "=",
...
//    json.title = bb;
//    console.log(1);
//    cc.getMedia(json,function(items){
//        console.log(2);
//        self.pictureNums(self.pictureNums()+items.length);
//    },function(erro){
//        alert(erro);
//    });
//    console.log(3)
